...
function setSelection(lon, lat) {
    ...
    if (lon > 120.214941 && lon <= 120.216788) {
        x=1;
    }
    else if (lon > 120.216788 && lon <= 120.218740) {
        x=2;
    }
    ...
    if(x==1 && y==1){
        ...
        console.log('yuan pin');
    }
    else if(x==2 && y==4){
        
        console.log('chunchen');
    }
    else if(x==2 && y==5){
        console.log('new parking');
    }
